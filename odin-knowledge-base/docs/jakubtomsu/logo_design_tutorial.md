...
![source](/posts/logo_design_tutorial/src.png)
...
![transformed](/posts/logo_design_tutorial/transform.png)

Here is what it looks like after all those distortions:

![warped](/posts/logo_design_tutorial/warped.png)
...
![Y normals](/posts/logo_design_tutorial/normal_y.png)
...
![gradient options](/posts/logo_design_tutorial/gradient_opts.png)

And here is what it looks like with the gradient:

![gradient](/posts/logo_design_tutorial/gradient.png)
...
![mask](/posts/logo_design_tutorial/mask.png)
...
![final](/posts/logo_design_tutorial/final.png)
...
![blinn phong](/posts/logo_design_tutorial/blinn_phong.png)

I used the following settings to sort of a metal material.
![blinn phong options](/posts/logo_design_tutorial/blinn_phong_opts.png)

And here is the settings for light sources, many possibilities here
![bling phong lights](/posts/logo_design_tutorial/blinn_phong_lights.png)

>Source: https://jakubtomsu.github.io/posts/logo_design_tutorial
