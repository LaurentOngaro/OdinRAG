...
Exceptions require unwinding the stack; this can be slower 

Theoretically exceptions can be just as fast a return statement because that’s effectively what it is. However, most modern languages do a lot more than that to implement exceptions and they can be a lot slower in pratice. when an exception happens compared to the fixed small cost of a return value.
...
>Source: https://www.gingerbill.org/article/2018/09/05/exceptions---and-why-odin-will-never-have-them
