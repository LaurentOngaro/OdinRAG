...
| --------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| `odin-knowledge-base/`                              | 114   | Skool 'programvideogames' lessons (Markdown with frontmatter)                               | Concrete implementation, complete code, game patterns |
...
| `odin-knowledge-base/docs/official/`                | 35    | Official odin-lang.org docs + awesome-odin                                                  | Official language reference                           |
...
**Total**: ~225 files, ~8 MB of MD.

## Skool courses (programvideogames)

See the detail in [`courses/programvideogames/README.md`](courses/programvideogames/README.md).

- **programvideogames** (1 lessons) - [`courses/programvideogames/README.md`](courses/programvideogames/README.md)
...
- **114** Skool lessons (Vertical Slice and Dice v1.0 + Metroidvania 1.0)
- **34** Karl book files (28 chapters + 4 appendices + about-author)
- **20** Zylinski articles
- **35** official odin-lang.org docs
- **1** official demo (`code/examples/demo.odin`)

## Skill to navigate

9 Kilo skills to query the KB and the workspace:

- `.kilo/skills/audit-public-safety/SKILL.md`
- `.kilo/skills/kb-navigator/SKILL.md`
- `.kilo/skills/markdown-style/SKILL.md`
...
- `.kilo/skills/readme-coherence/SKILL.md`
...
### Cross-language style references

Documents that are NOT Odin-specific but inform OdinRAG project decisions. Stored in `odin-knowledge-base/references/`. English only on the public branch; translations are tagged `lang/fr` and annotated with `exception:`.

- `odin-knowledge-base/references/tiger_style.md` - TigerBeetle safety-critical coding style (assertions, no recursion, fixed-size types, naming) - directly applicable to Odin
- `odin-knowledge-base/references/tiger_style-fr.md` - French translation of TigerStyle for personal reading (N.d.T. preserved quotes)
- `odin-knowledge-base/references/README - references.md` - entry point + conventions for this folder
