...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Odin syntax          | `odin-knowledge-base/docs/official/` (the official odin-lang.org docs, mirror-redistributed under Odin's open licence)                                                                                                               |
| Allocators           | `odin-knowledge-base/docs/karl_zylinski/temporary-allocator-your-first-arena.md`; `odin-knowledge-base/courses/programvideogames/vertical-slice-and-dice-v10/metroidvania/*-memory-allocators.md` (when the Skool course is indexed) |
| Hot reload           | `odin-knowledge-base/docs/karl_zylinski/hot-reload-gameplay-code.md`; `odin-knowledge-base/.../rpg/084-22-hot-reloading.md`; `.../rpg/085-23-hot-reloading-integration.md` (when indexed)                                            |
...
6. **If the KB is insufficient**: acknowledge the limit, suggest searching in `odin-knowledge-base/docs/official/` or the official Odin docs.
...
- Never invent Odin syntax (the language is strict - check against `odin-knowledge-base/docs/official/` or `odin-lang.org/docs/`).
