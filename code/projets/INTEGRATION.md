...
Document explaining how the AI assistant (Kilo Code) cross-references **your code** in `code/projets/<your-project>/` with **the knowledge base** elsewhere in the repo.

## The global workspace

```
OdinRAG/
├── code/projets/<your-project>/    <- YOU work here (code, devlogs, AGENTS.md)
...
When you code in `code/projets/<your-project>/src/`, Kilo sees **the whole workspace**, so it has access to your KB alongside your code. That is exactly what we want.
...
```
1. You open code/projets/<your-project>/src/main.odin
...
2. **`code/projets/<your-project>/AGENTS.md`** -> project-specific context (patterns used, dependencies, state)
...
Example `code/projets/my-rpg/AGENTS.md`:
...
- **Compilation in this repo**: no Odin build here. The code in `code/projets/` is **reference material** (learning, patterns), not code ready to compile.
