...
### ***Solar Storm*** from `Jakub` [#](#solar-storm-from-jakub)
...
### ***The Legend of Ján Ïtor*** from `Colin Bellino` [#](#the-legend-of-ján-ïtor-from-colin-bellino)
...
&amp;lt;a href=https://colinbellino.itch.io/the-legend-of-jan-itor&amp;gt;The Legend of Ján Ïtor 💀 by Colin Bellino, Flip, TillerQueen&amp;lt;/a&amp;gt;

### ***CAT & ONION*** from `karl_zylinski` [#](#cat--onion-from-karl_zylinski)
...
&amp;lt;a href=https://zylinski.itch.io/cat-and-onion&amp;gt;CAT &amp;amp; ONION by Zylinski Games&amp;lt;/a&amp;gt;

## Community Contributions [#](#community-contributions)

### Dynlib Helpers by Jeroen [#](#dynlib-helpers-by-jeroen)
...
hellope = 42
```odin
### Odin / WASM / Webgl by thetarnav [#](#odin--wasm--webgl-by-thetarnav)
...
- [red\_black\_tree](https://github.com/wilig/red_black_tree) - simple red black tree implementation
...
- [blas\_bindings](https://github.com/jon-lipstate/blas_bindings) - BLAS Bindings for Odin
- [sign\_extension](https://gist.github.com/dotbmp/1d80d679ac93a5785b716aee163d7056) - Little sign-extension and zero-extension helpers
...
[mustache](https://github.com/benjamindblock/odin-mustache#layouts)
...
Got an LED to blink on my RP4 - thanks to @irvin for adding the freestanding\_arm64 target and sharing his example code! - markersniffen
...
[Based on this article](https://nullprogram.com/blog/2017/11/03/)
...
[![...](https://cdn.discordapp.com/attachments/568871319425515531/1197321983294181556/Code_o73MgoeB1L.gif?ex=65f236fd&is=65dfc1fd&hm=33ae2e77b400776063b4c69b2701725a461cb6c462951262813d42987fbb3fbb&)](https://github.com/Daxode/odecs/)
...
[Source](https://github.com/Daxode/odecs/)
...
[Source](https://es-lo-que-es.github.io/hex-chess-web-build/)
...
Been getting quite annoyed with the sluggish windows file explorer recently... - Francis\_the\_cat
...
>Source: https://odin-lang.org/news/newsletter-2024-02
