...
- **NOT shipped** (paid / paywall): `odin-knowledge-base/docs/karl_zylinski/odin-book/`, `odin-knowledge-base/courses/`.
...
4. Output: `odin-knowledge-base/docs/karl_zylinski/odin-book/01-...33-about-the-author.md` (all gitignored).
