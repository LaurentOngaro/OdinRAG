#!/usr/bin/env python3
"""
_Helpers/scrape-official.py - Official Docs Scraper (odin-lang.org)
...
Usage:
    python _Helpers/scrape-official.py            # skip if already exported (re-entrant)
    python _Helpers/scrape-official.py --force    # force full rewrite
...
Output:
    docs/official/<path>.md      (/docs/ pages, footer ">Source: <url>")
    docs/official/awesome-odin.md  (raw README from jakubtomsu/awesome-odin)
...
# ─── CONFIG ───────────────────────────────────────────────────────────────────
OUT = Path(__file__).resolve().parent.parent / "docs" / "official"
