...
def scrape_to_markdown(
    ...
    *,
    ...
    if format_odin and output_path.suffix.lower() == ".md":
        # Add both _Helpers/ and repo root to sys.path so that odin_format can import _Helpers.lib.user_config.
        _helpers_dir = Path(__file__).resolve().parent.parent
        _repo_root = _helpers_dir.parent
