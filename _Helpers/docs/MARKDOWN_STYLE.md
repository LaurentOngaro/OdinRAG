---
title: "OdinRAG - Markdown style"
date: 2026-07-01
tags: [OdinRAG, doc/convention, markdown, style]
type: convention
status: active
priority: 2
docId: MARKDOWN_STYLE_001
summary: "Markdown prose convention for tracked .md files in OdinRAG. One paragraph = one physical line. Detailed rules, examples, and the rationale live here, NOT in AGENTS.md (kept there to a 2-line pointer to avoid priming unwanted reflexes in AI agents)."
---
...
```markdown
- **Frontmatter** - the schema is in [`_Helpers/docs/FRONTMATTER_CONVENTIONS.md`](FRONTMATTER_CONVENTIONS.md) (5 main fields + hierarchical Obsidian tags).
...
| `docs/karl_zylinski/odin-book/`| 34    | Karl's book split into 1 file per chapter                                      |
```
