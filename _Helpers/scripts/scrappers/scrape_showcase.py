...
Output:
    odin-knowledge-base/docs/showcase/<slug>.md      (each showcase page, footer ">Source: <url>")
    odin-knowledge-base/docs/showcase/README.md      (generated index of all scraped pages)
...
# ─── CONFIG ───────────────────────────────────────────────────────────────────
OUT = Path(__file__).resolve().parents[3] / "odin-knowledge-base" / "docs" / "showcase"
...
def generate_readme(slugs: list[str]) -> None:
    """Generate odin-knowledge-base/docs/showcase/README.md listing all scraped pages."""
    lines: list[str] = [
        "# Odin Showcase",
        "",
