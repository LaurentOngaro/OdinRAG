#!/usr/bin/env python3
"""
_Helpers/scripts/scrappers/scrape_skool.py - Skool Course Scraper (programvideogames)
...
Usage:
python _Helpers/scripts/scrappers/scrape_skool.py [options]
...
CREDENTIALS_FILE = ROOT_DIR / "_Private" / ".config" / "skool_credentials.txt"
# YouTube cookies (optional but recommended to avoid the rate-limit):
...
def setup_credentials() -> None:
    ...
    2. skool.email field of _Private/.config/user_config.jsonc
