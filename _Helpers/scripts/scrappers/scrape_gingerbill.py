#!/usr/bin/env python3
"""
_Helpers/scripts/scrappers/scrape_gingerbill.py - Scrape gingerbill.org articles via RSS.
...
Usage:
    python _Helpers/scripts/scrappers/scrape_gingerbill.py            # skip if already exported (re-entrant)
    python _Helpers/scripts/scrappers/scrape_gingerbill.py --force    # force full rewrite
    python _Helpers/scripts/scrappers/scrape_gingerbill.py --check    # dry-run, list what would be scraped
