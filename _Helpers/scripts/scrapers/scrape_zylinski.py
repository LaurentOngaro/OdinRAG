#!/usr/bin/env python3
"""
_Helpers/scripts/scrapers/scrape_zylinski.py - Blog Scraper (karl zylinski)
...
Usage:
    python _Helpers/scripts/scrapers/scrape_zylinski.py            # skip if already exported (re-entrant)
    python _Helpers/scripts/scrapers/scrape_zylinski.py --force    # force full rewrite
