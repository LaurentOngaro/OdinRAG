...
Usage:
    python _Helpers/scripts/fixes/reflow_md.py            # dry-run
    python _Helpers/scripts/fixes/reflow_md.py --apply    # rewrite the files
    python _Helpers/scripts/fixes/reflow_md.py --path X   # alternate root
    python _Helpers/scripts/fixes/reflow_md.py --check    # exit non-zero if any file would change
