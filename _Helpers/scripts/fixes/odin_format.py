"""_Helpers/scripts/fixes/odin_format.py - Reusable odinfmt wrapper.
...
`format_path(path) -> bool`
    ...
    2. `_Private/.config/user_config.jsonc` (field paths.odinfmt_exe)
...
ODINFMT_CONFIG = Path(__file__).resolve().parents[3] / "odinfmt.json"
