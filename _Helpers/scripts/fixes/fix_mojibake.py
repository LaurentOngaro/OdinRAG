...
Usage:
- python _Helpers/scripts/fixes/fix_mojibake.py            # dry-run
- python _Helpers/scripts/fixes/fix_mojibake.py --apply    # write the fixes
- python _Helpers/scripts/fixes/fix_mojibake.py --path X   # alternate root
"""
