...
Usage:
    ...
    python _Helpers/scripts/diagnostic/auditReadmeCoherence.py --scope docs
    python _Helpers/scripts/diagnostic/auditReadmeCoherence.py --scope docs/official
...
HELPERS_DIR = Path(__file__).resolve().parents[2]
