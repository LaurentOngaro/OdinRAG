...
Usage:
    python _Helpers/scripts/diagnostic/audit_public_safety.py            # check (exit 0 if clean)
    python _Helpers/scripts/diagnostic/audit_public_safety.py --verbose  # list every tracked file
...
FORBIDDEN_PATTERNS = [
    ...
    ("_Private/planning/daily/", "Daily planning personnel"),
    ("code/projects/PVG03_RPG/", "Personal Odin project code (not part of the RAG)"),
    ("_Private/raw/", "Captures brutes / one-shot"),
]
